...
if (!empty($user['poste_id'])) {
    // Utilisez le bon nom de colonne pour l'identifiant du département
...
<head>
    ...
    <style>
        ...
        .header {
            background-color:rgb(126, 132, 126);
            color: white;
            padding: 10px 20px;
            text-align: center;
        ...
        .container {
            ...
            padding: 15px;
            border-radius: 10px;
            box-shadow: 0 4px 10px rgb(126, 132, 126);
        }
...
<div class="header">
    <h1>Profile de <?php echo htmlspecialchars($nom . ' ' . $prenom); ?></h1>
</div>
